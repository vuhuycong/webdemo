    ...
    <div class="container">
        ...
        <div class="pull-right">
            <div class="beta-breadcrumb font-large">
                <a href="index">Home</a> / <span>Thông tin chi tiết sản phẩm</span>
            </div>
        </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="single-item">
                                <div class="single-item-header">
                                    <a href="{{route('chitietsanpham',$sptt->id)}}"><img src="source/image/product/{{$sptt->image}}" height="200px" alt=""></a>
                                </div>
                                <div class="single-item-body">
