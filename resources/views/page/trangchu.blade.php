                ...
                <div class="row">
                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-caption" style="margin-bottom: 10px">
                                                ...
                                                <a class="beta-btn primary" href="{{route('chitietsanpham',$new->id)}}" style="margin-left: 5px">Details <i class="fa fa-chevron-right"></i></a>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="beta-products-list">
                            ...
                            <div class="beta-products-details">
                                <p class="pull-left">Có {{count($sanpham_km)}} sản phẩm</p>
                                <div class="clearfix"></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-caption" style="margin-bottom: 10px">
                                            ...
                                            <a class="beta-btn primary" href="{{route('chitietsanpham',$spkm->id)}}" style="margin-left: 5px">Details <i class="fa fa-chevron-right"></i></a>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
