<div id="header">
        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href=""><i class="fa fa-home"></i> Số 145 đường Z115 Tổ 4 P.Tân Thịnh TPTN</a></li>
                    <li><a href=""><i class="fa fa-phone"></i> 0984 063 988</a></li>
                </ul>
            </div>
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="index" id="logo"><img src="source/assets/dest/images/daithuan-logo.jpg" height="150px" width="700px" alt=""></a>
            </div>
        ...
        <div class="container">
            ...
            <nav class="main-menu">
                <ul class="l-inline ov">
                    ...
                    <li><a href="loai-san-pham">Các hãng sản phẩm</a>
                        <ul class="sub-menu">
